...
static void rna_def_game_object_activity_culling(BlenderRNA *brna)
{
	...
	RNA_def_property_range(prop, 0.0, FLT_MAX);
	RNA_def_property_ui_text(prop, "Logic Radius", "Distance to begin suspend logic of this object");

	prop = RNA_def_property(srna, "animation_radius", PROP_FLOAT, PROP_DISTANCE);
	RNA_def_property_float_sdna(prop, NULL, "animationRadius");
	RNA_def_property_range(prop, 0.0, FLT_MAX);
	RNA_def_property_ui_text(prop, "Animation Radius", "Distance to begin suspend animation of this object");
	...
	RNA_def_property_ui_text(prop, "Cull Logic", "Suspend logic of this object by its distance to nearest camera");

	prop = RNA_def_property(srna, "use_animation", PROP_BOOLEAN, PROP_NONE);
	RNA_def_property_boolean_sdna(prop, NULL, "flags", OB_ACTIVITY_LOGIC);
	RNA_def_property_ui_text(prop, "Cull Animation", "Suspend animation of this object by its distance to nearest camera");
}
